...
+ (ZSSRecordView *)showInView:(UIView *)view finish:(FinishBlock)finishBlock {
    ZSSRecordView *recordView = [ZSSRecordView new];
    
    __weak ZSSRecordView *weakRecordView = recordView;
    ZSSMaskView *maskView = [ZSSMaskView showInView:view dissmissBlock:^{
